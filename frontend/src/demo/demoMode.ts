 ...
 * the 60-second local install, and the DemoTimeline media bar drives playback.
 *
...
export const INSTALL_HINT = "Live chat needs the local install — 60 seconds, zero keys.";
