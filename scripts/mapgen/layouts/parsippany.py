...
LAKE_BLOB = R.Blob(
    ...
    nw=R.gid(61, 66), n=(R.gid(61, 67), R.gid(61, 68)), ne=R.gid(61, 69),
    w=(R.gid(62, 65), R.gid(63, 65)), e=(R.gid(62, 70), R.gid(63, 70)),
    sw=R.gid(64, 66), s=(R.gid(64, 67), R.gid(64, 68)), se=R.gid(64, 69),
)


def _lake(m: MapCanvas) -> None:
    cells = {(x, y) for y, (x0, x1) in LAKE_SPANS.items()
...
def _fence_rect(m: MapCanvas, x: int, y: int, w: int, h: int,
...
def compose(m: MapCanvas) -> None:
    ...
    storefront(m, 55, 26, 8, 7, facade="stone_small", roof="deck_light",
               sign=1)
    ...
    for x, y in ((38, 44), (41, 46), (38, 30)):
        m.tree(x, y, stamp=rng.choice(("tree_light", "tree_dark")))
    for x, y in ((8, 47), (15, 48), (22, 46), (27, 48), (44, 47),
                 (54, 48), (66, 48), (72, 46), (73, 42)):
        m.tree(x, y, stamp=rng.choice(("tree_light", "tree_dark",
                                       "tree_round_small")))
