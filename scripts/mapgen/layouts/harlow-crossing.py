...
def _fence_pen(m: MapCanvas, x: int, y: int, w: int, h: int,
    ...
    for i, rx in enumerate(range(x + 2, x + w - 2)):
        ...
        if rx not in gate_cols:
            m.stamp("deco-below", f["rail_h_a" if i % 2 else "rail_h_b"],
                    rx, y + h - 2)
...
def compose(m: MapCanvas) -> None:
    ...
    storefront(m, 14, 13, 4, 6, facade="stone_small", roof="stone",
               window=False, sign=None)                            # bank
    storefront(m, 18, 13, 4, 6, facade="cream", awning=True)       # barber
    storefront(m, 22, 13, 5, 6, facade="cream", roof="stone",
               sign=None)                                          # laundromat
    # -- Rocco's Slice House
    ...
    storefront(m, 9, 34, 6, 7, facade="cream", roof="deck_light",
               door_dx=3, sign=None)
    storefront(m, 16, 34, 6, 7, facade="brick", roof="deck_dark",
               door_dx=3, sign=None)
    storefront(m, 26, 34, 6, 7, facade="cream", roof="stone",
               door_dx=3, sign=None)
    ...
    m.meadow(53, 8, 6, 5)
    path(m, {(55, 9), (56, 9), (57, 9),
             (55, 10), (56, 10), (57, 10)})          # sand pit
    ...
    path(m, {(65, 14), (66, 14),
             ...
             (65, 17), (66, 17)})
    path(m, {(65, 18), (66, 18), (65, 19), (66, 19),
             (65, 20), (66, 20), (65, 21), (66, 21),
             (65, 22), (66, 22)})                    # memorial walk
    ...
    m.blob("ground-detail", {(66, 31), (67, 31), (65, 32), (66, 32),
                             (67, 32), (65, 33), (66, 33), (67, 33)},
           R.PATH_TAN)
