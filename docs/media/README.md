...
| Artifact | Purpose |
|---|---|
| [`hero.gif`](hero.gif) | README opening sequence, canvas-only: the town overview with residents mid-routine, one conversation beat, then dusk-to-night as windows and lamps come on |
